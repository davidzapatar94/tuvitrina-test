...
<p class="myaccount_vendor_dashboard">
    ...
    if( ! $is_pending ){
        echo ' ';
        printf( __( 'Click <a href="%s">here</a> to access <strong>%s dashboard</strong>.', 'yith_wc_product_vendors' ), apply_filters( 'yith_wcmv_my_vendor_dashboard_uri', esc_url( admin_url() ) ), $vendor_name );
    }
