...
<?php $tax_label = apply_filters( 'yith_wcmv_tax_label_admin', __( 'VAT/SSN', 'yith_wc_product_vendors' ) ); ?>
...
<tr class="form-field">
    <th scope="row" valign="top">
        <label for="yith_vendor_vat"><?php echo apply_filters( 'yith_wcmv_tax_label_admin', __( 'VAT/SSN', 'yith_wc_product_vendors' ) ); ?></label>
    </th>
    <td>
        <input type="text" class="regular-text" name="yith_vendor_data[vat]" id="yith_vendor_vat" value="<?php echo $vendor->vat ?>" /><br />
        <span class="description"><?php printf( '%s %s.', __( 'Vendor\'s', 'yith_wc_product_vendors' ), $tax_label ); ?></span>
    </td>
</tr>
