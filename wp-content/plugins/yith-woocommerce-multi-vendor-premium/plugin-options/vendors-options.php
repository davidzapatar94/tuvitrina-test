...
return apply_filters( 'yith_wpv_panel_vendors_options', array(
        ...
        'vendors' => array(
            ...
            'vendors_order_management'      => array(
                'title'   => __( 'Enable order management-Null24.Net', 'yith_wc_product_vendors' ),
                'type'    => 'checkbox',
            ...
            'vendors_order_synchronization' => array(
                ...
                'type'    => 'checkbox',
                'desc'    => __( "All changes to general orders will be synchronized with the individual vendor's order-Nu ll 2 4 . NET", 'yith_wc_product_vendors' ),
