...
return array(
    ...
    'add-ons' => array(
        ...
        'vendors_catalog_mode_title'        => array(
            'title' => __( 'Catalog Mode', 'yith_wc_product_vendors' ),
            'type'  => 'title',
        ...
        'vendors_enable_catalog_mode'       => array(
            'title'             => __( 'Enable Catalog Mode for vendors', 'yith_wc_product_vendors' ),
            'type'              => 'checkbox',
        ...
        'vendors_role_based_prices_title'        => array(
            'title' => __( 'Role Based Prices', 'yith_wc_product_vendors' ),
            'type'  => 'title',
        ...
        'vendors_role_based_prices_mode'       => array(
            'title'             => __( 'Enable Role Based Prices for vendors', 'yith_wc_product_vendors' ),
            'type'              => 'checkbox',
        ...
        'vendors_advanced_product_options_title'        => array(
            'title' => __( 'Advanced Product Options', 'yith_wc_product_vendors' ),
            'type'  => 'title',
        ...
        'vendors_advanced_product_options_mode'       => array(
            'title'             => __( 'Enable Advanced Product Options for vendors', 'yith_wc_product_vendors' ),
            'type'              => 'checkbox',
