    ...
    class YITH_Vendors_Frontend_Premium extends YITH_Vendors_Frontend {
        ...
        public function get_registration_error_string( $field = 'all' ){
            $errors = array(
                ...
                'antispam'             => __( 'Please, no spam here', 'yith_wc_product_vendors' ),
            );
        ...
        public function add_sold_by_vendor( $product_title, $cart_item, $cart_item_key = false ) {
            ...
            if ( $vendor->is_valid() ) {
                $product_title .= ' (<small>' . apply_filters('yith_wcmv_sold_by_string_frontend', _x( 'Sold by', 'Cart details: Product sold by', 'yith_wc_product_vendors' ) ) . ': ' . '<a href="' . $vendor->get_url( 'frontend' ) . '">' . $vendor->name . '</a></small>)';
            }
