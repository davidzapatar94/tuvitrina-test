    ...
    class YITH_Commissions_Earnings_By_Vendor_Table extends WP_List_Table {
        ...
        public function get_columns() {
            $columns = array(
                ...
                'count'             => __( 'Sold products', 'yith_wc_product_vendors' ),
        ...
        public function column_default( $rec, $column_name ) {
            switch ( $column_name ) {
                ...
                case 'oldest_commission':
                    ...
                    $t_time = date_i18n( __( 'Y/m/d g:i:s A', 'yith_wc_product_vendors' ), mysql2date( 'U', $oldest_commission_date ) );
        ...
        protected function get_views() {
            ...
            $views = array(
                ...
                'paid'   => __( 'Payment Request', 'yith_wc_product_vendors' ),
            );
