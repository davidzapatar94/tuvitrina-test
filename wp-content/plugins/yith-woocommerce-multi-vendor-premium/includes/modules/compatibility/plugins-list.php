...
return array(
    ...
    'catalog-mode' => array(
        ...
        'option_desc'       => __( 'If you enable this option, vendors will be able to manage the selling of their products.', 'yith_wc_product_vendors' ),
    ...
    'role-based-prices' => array(
        ...
        'option_desc'       => __( 'If you enable this option, vendors will be able to create custom price rules for their own products.', 'yith_wc_product_vendors' ),
        'post_types'        => array( 'yith_price_rule' ),
        'capabilities'      => apply_filters( 'yith_wrbp_vendor_caps', yith_wcmv_create_capabilities( array( 'price_rule', 'price_rules' ) ) ),
    ...
    'advanced-product-options' => array(
        'name'              => 'YITH WooCommerce Advanced Product Options',
        'landing_uri'       => '//yithemes.com/themes/plugins/yith-woocommerce-advanced-product-options/',
        'option_desc'       => __( 'If you enable this option, vendors will be able to create advanced product options for their products.', 'yith_wc_product_vendors' ),
